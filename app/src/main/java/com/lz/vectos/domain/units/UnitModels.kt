...
@Serializable
@JvmInline
value class Length(internal val inches: Double) : Comparable<Length> {
...
@Serializable
@JvmInline
value class Force(internal val pounds: Double) : Comparable<Force> {
...
@Serializable
@JvmInline
value class Moment(internal val lbIn: Double) : Comparable<Moment> {
...
@Serializable
@JvmInline
value class Pressure(internal val psi: Double) : Comparable<Pressure> {
    override fun compareTo(other: Pressure): Int = this.psi.compareTo(other.psi)
}

@Serializable
@JvmInline
value class Stress(internal val psi: Double) : Comparable<Stress> {
    override fun compareTo(other: Stress): Int = this.psi.compareTo(other.psi)
}

@Serializable
@JvmInline
value class ElasticModulus(internal val psi: Double) : Comparable<ElasticModulus> {
    override fun compareTo(other: ElasticModulus): Int = this.psi.compareTo(other.psi)
}

@Serializable
@JvmInline
value class ForcePerLength(internal val pli: Double) {
...
@Serializable
@JvmInline
value class MomentOfInertia(internal val inchesToFourth: Double)
...
@Serializable
@JvmInline
value class Area(internal val squareInches: Double)
val Double.in2 get() = Area(this)
val Double.cm2 get() = Area(this / 6.4516)

@Serializable
@JvmInline
value class SectionModulus(internal val cubicInches: Double)
