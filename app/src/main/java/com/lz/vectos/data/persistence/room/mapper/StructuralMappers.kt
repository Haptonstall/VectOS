package com.lz.vectos.data.persistence.room.mapper
...
import com.lz.vectos.data.persistence.room.dao.BuildingCodeWithDetails
import com.lz.vectos.data.persistence.room.dao.CombinationSetWithDetails
import com.lz.vectos.data.persistence.room.dao.CombinationWithFactors
...
fun BuildingCodeWithDetails.toDomainModel(baseCode: BuildingCode? = null): BuildingCode {
    return BuildingCode(
        ...
        stateSpecificReferences = try {
            json.decodeFromString<Map<CodeReferenceKey, String>>(this.buildingCode.references_json)
        } catch (e: Exception) {
            emptyMap()
        },
