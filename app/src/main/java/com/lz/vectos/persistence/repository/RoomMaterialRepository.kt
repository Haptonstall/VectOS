...
import com.lz.vectos.domain.beam.MaterialRepository
...
import com.lz.vectos.persistence.room.dao.MaterialDao
    ...
    private fun MaterialRoomEntity.toDomain(): MaterialGrade {
        return when (type) {
            ...
            MaterialType.WOOD -> MaterialGrade.Wood(
                id = id,
                name = name,
                species = species ?: com.lz.vectos.domain.structural.WoodSpecies.DF_L,
                grade = grade ?: com.lz.vectos.domain.structural.WoodGrade.NO_2,
